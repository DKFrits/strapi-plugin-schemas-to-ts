...
class Converter {
    ...
    SchemasToTs() {
        ...
        const commonSchemas = this.interfaceBuilder.generateCommonSchemas(this.destinationPaths.commons, this.destinationPaths.extensions);
        ...
        const extensionSchemas = this.getSchemas(this.destinationPaths.extensions, schemaSource_1.SchemaSource.Extension);
    ...
    parseSchema(file, schemaSource, apiSchemas) {
        ...
        switch (schemaSource) {
            case schemaSource_1.SchemaSource.Api:
                ...
                folder = this.destinationPaths.useForApisAndComponents ? this.destinationPaths.apis : path_1.default.dirname(file);
                break;
            ...
            case schemaSource_1.SchemaSource.Extension:
                ...
                folder = this.destinationPaths.useForApisAndComponents ? this.destinationPaths.extensions : path_1.default.dirname(file);
                break;
