...
class PreV414InterfaceBuilder extends interfaceBuilder_1.InterfaceBuilder {
    ...
    addVersionSpecificCommonSchemas(commonSchemas, commonFolderModelsPath) {
        this.addCommonSchema(commonSchemas, commonFolderModelsPath, 'BeforeRunEvent', `import type { Event } from '@strapi/database/lib/lifecycles/index';
  
    export interface BeforeRunEvent<TState> extends Event {
      state: TState;
    }`);
        this.addCommonSchema(commonSchemas, commonFolderModelsPath, 'AfterRunEvent', `import type { BeforeRunEvent } from './BeforeRunEvent';
