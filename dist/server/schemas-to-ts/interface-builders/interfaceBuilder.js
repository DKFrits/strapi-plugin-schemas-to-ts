...
class InterfaceBuilder {
    ...
    generateCommonSchemas(commonFolderModelsPath, extensionFolderModelsPath) {
        const commonSchemas = [];
    ...
    `);
        if (extensionFolderModelsPath && fileHelpers_1.FileHelpers.folderExists(`${extensionFolderModelsPath}/users-permissions/content-types/user`)) {
            this.addCommonSchema(commonSchemas, commonFolderModelsPath, 'User', `import type {FullUser, FullUser_Plain, FullUser_NoRelations} from "../../extensions/users-permissions/content-types/user/FullUser";
    ...
    `);
        this.addCommonSchema(commonSchemas, commonFolderModelsPath, 'Media', `import type { MediaFormat } from './MediaFormat';
    ...
    convertToInterface(schemaInfo, allSchemas, schemaType) {
        ...
        for (const dependency of builtInterface.interfaceDependencies) {
            ...
            if (dependency !== schemaInfo.pascalName &&
                ...
                const dependencyImport = `import type { ${dependency} } from '${importPath}';`;
