...
class DestinationPaths {
    constructor(config, strapiPaths) {
        ...
        if (destinationFolder) {
            ...
            this.extensions = fileHelpers_1.FileHelpers.ensureFolderPathExistRecursive(destinationFolder, this.extensionsFolderName);
        ...
        if (useDefaultFolders) {
            ...
            this.extensions = fileHelpers_1.FileHelpers.ensureFolderPathExistRecursive(strapiPaths.app.src, this.extensionsFolderName);
        }
